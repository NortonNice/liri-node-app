...
/*`node liri.js spotify-this-song '<song name here>'`
   ...
   * to register a new application to be used with the Spotify API. You can fill in 
   ...
   * client secret. Copy these values down somewhere, you'll need them to use the Spotify API 
   * and the [node-spotify-api package](https://www.npmjs.com/package/node-spotify-api).
*/
movie-this 
